...
public class PePePePlayer extends StateMachineGamer {
	...
	System.out.println("possible moves calculated are : " + moves.toString());
	Move selection = null;
	System.out.println("mDepthLimit : " + mDepthLimit);
	...
	if (depth > mDepthLimit || timeoutReached())
	{
	    ...
	    {
		return monteCarloEvaluation(currentState.getState());
	    }
	}
    ...
    public int monteCarloEvaluation(MachineState currentState) throws TransitionDefinitionException,
